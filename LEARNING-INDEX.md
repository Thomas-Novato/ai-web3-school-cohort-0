...
| 项目 | 内容 |
|------|------|
| AI 基础 | 有基础（概念 + AI 工具使用，无 AI 开发经验） |
| Web3 基础 | 有基础（了解基本概念） |
| 编程能力 | C++（有编程基础） |
...
| [2026-06-09](daily/2026-06-09.md) | 2026-06-09 学习打卡 — Agent 数据指标体系与行为画像 | 四类指标体系 + 五项 Agent 行为画像 | ~1.5h | 框架完成 |
| [2026-06-10](daily/2026-06-10.md) | 2026-06-10 学习打卡 — Agent Economy 首页交互叙事重设计 | 首页叙事重构 + 活跃钱包/搜索/热搜词 | ~1.5h | 方案确认 |
...
| 👤 低-中 | 用户输入 | 低-中 |
| ⚠️ 低 | dApp 页面内容 | 仅作为声称 |
| ❌ 最低 | Memory / 历史记录 | 不能用于授权判断 |

### Agent 铁律

- Agent **绝不**接触私钥 / 助记词
- 签名和转账必须有**人工确认**
- Agent 的核心是**被约束的执行循环**，不是自由意志
- 只读操作可自动执行；高风险写入须 policy → simulation → 用户确认
- 状态管理应**外置**，方便恢复、审计、追责

### Context Spec 元信息设计

每个上下文字段需携带：`source`、`timestamp`、`freshness`、`trust_level`、`permission_scope`、`chain_id`、`block_number`、`verification_method`、`can_be_used_as_fact`、`expiry`

### Web3 概念的 AI 类比

| Web3 概念 | AI 类比 |
|-----------|---------|
| 区块链网络 | append-only 的状态数据库（无数节点维护） |
| 钱包 | API Key + 公开 userId |
| 签名 | 私钥盖章，加密可验证 |
| Gas | API 调用的 token 费用 |
| 智能合约 | 部署在链上的 serverless function（不可变） |
| 区块浏览器 | 链上的 Kibana / Grafana 日志面板 |
...
| 任务 | 完成日期 | 详情 |
|------|:--------:|------|
| 完成 WCB 打卡 | 2026-05-18 | 见 [daily/2026-05-18.md](daily/2026-05-18.md) |
| 完成第一个学习笔记 | 2026-05-18 | 见 [daily/2026-05-18.md](daily/2026-05-18.md) |
| 完成 AI 基础前 3 章: LLM, Prompt, Context | 2026-05-18 | 见 [daily/2026-05-18.md](daily/2026-05-18.md) |
| 理解 Prompt 工程的实践方法 | 2026-05-19 | 见 [daily/2026-05-19.md](daily/2026-05-19.md) |
| 完成 WCB 打卡 | 2026-05-19 | 见 [daily/2026-05-19.md](daily/2026-05-19.md) |
| 完成学习笔记和知识整理 | 2026-05-20 | 见 [daily/2026-05-20.md](daily/2026-05-20.md) |
| 完成 WCB 打卡 | 2026-05-20 | 见 [daily/2026-05-20.md](daily/2026-05-20.md) |
| **完成测试网交互（Sepolia 交易 + 合约部署）** ✅ | 2026-05-21 | 见 [daily/2026-05-21.md](daily/2026-05-21.md) |
| **学习 Agent 基础概念** ✅ | 2026-05-21 | 见 [daily/2026-05-21.md](daily/2026-05-21.md) |
| 完成最小 AI × Web3 交叉实验（流程图或实际操作） | 2026-05-21 | 见 [daily/2026-05-21.md](daily/2026-05-21.md) |
...
├── README.md
├── LEARNING-INDEX.md  ← 本文件
├── profile.md
├── learning-plan.md
├── scripts/
│   └── update-learning-index.py
├── daily/
│   ├── 2026-05-18.md
│   ├── 2026-05-19.md
│   ├── 2026-05-20.md
